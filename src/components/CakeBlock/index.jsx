...
function CakeBlock({ id, name, imageUrl, price, types, sizes, onClickAddCake, addedCount }) {
    const availableTypes = ['с кремом', 'без крема'];
    ...
    return (
        <div className="cake-block">
            ...
            <div className="cake-block__bottom">
                ...
                <Button onClick={onAddCake} className="button--add" outline>
                    <svg
                        width="12"
                        height="12"
                        viewBox="0 0 12 12"
...
CakeBlock.propTypes = {
    ...
    onClickAddCake: PropTypes.func,
    addedCount: PropTypes.number,
};

CakeBlock.defaultProps = {
    name: '---',
    price: 0,
    types: [],
    sizes: [],
