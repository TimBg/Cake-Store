...
import { Categories, SortPopup, CakeBlock, CakeLoadingBlock } from '../components';

import { setCategory, setSortBy } from '../redux/actions/filters';
import { fetchCakes } from '../redux/actions/cakes';
import { addCakeToCart } from '../redux/actions/cart';

const categoryNames = ['Бисквитные', 'Вафельные', 'Песочные', 'Творожные'];
const sortIems = [
        ...
        <div className="container">
            ...
            <div className="content__items">
                {isLoaded
                    ? items.map((obj) => (
                        <CakeBlock
                            onClickAddCake={handleAddCakeToCart}
                            key={obj.id}
                    ...
                    : Array(12)
                        .fill(0)
                        .map((_, index) => <CakeLoadingBlock key={index} />)}
            </div>
        </div>
    );
}
